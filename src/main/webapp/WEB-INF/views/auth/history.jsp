                   ...
                   <div class="card">
                       ...
                       <div class="card-body" id="table">
                           <ul class="nav nav-pills nav-primary">
                               <li class="nav-item">
                                   <a class="nav-link"
                                      href="${pageContext.request.contextPath}/me/borrowing"
                                      up-alias="${pageContext.request.contextPath}/me/borrowing?*"
                                      up-follow>Borrowing</a>
                               </li>
                               <li class="nav-item">
                                   <a class="nav-link"
                                      href="${pageContext.request.contextPath}/me/borrowing/history"
                                      up-alias="${pageContext.request.contextPath}/me/borrowing/history?*"
                                      up-follow>History</a>
                               </li>
                           </ul>
                               ...
                               <div class="tab-pane fade show active">
                                   ...
                                   <div class="table-responsive">
                                       <table class="table">
                                           ...
                                           <tbody>
                                           <c:forEach var="item" items="${data.content}" varStatus="loop"><tr>
                                               <th scope="row">
