...
<layout:modal>
    <jsp:attribute name="title">Delete Info</jsp:attribute>
                ...
                <div class="modal-content">
                    <div class="modal-body d-flex flex-column align-items-center pt-4 pb-3">
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <span>Are you sure delete this item (${entity.booksCount} books will be deleted)</span>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <div class="modal-footer">
                        ...
                        <c:if test="${entity.booksCount == 0}">
                            <form action="${pageContext.request.contextPath}/library/books/infos/${id}/delete"
                        ...
                        <c:if test="${entity.booksCount > 0 && canForce}">
                            <form action="${pageContext.request.contextPath}/library/books/infos/${id}/force-delete"
                                  method="post" up-layer="parent root" up-scroll="false">
                                <sec:csrfInput/>
