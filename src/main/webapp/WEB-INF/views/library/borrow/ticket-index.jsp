...
<%--@elvariable id="data" type="org.springframework.data.domain.Page<io.lana.libman.core.book.Ticket>"--%>
                                ...
                                <div class="tab-pane fade show active">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td  <component:table-higlight
                                                    test="${isHighlight}"/>>
                                                <c:set var="reader" value="${item.reader}"/>
                                            ...
                                            <td <component:table-higlight
                                                    test="${isHighlight}"/>>
                                                <span class="ms-2">${ item.borrowingsCount }</span>
                                                /
                                                <span class="ms-2">${ item.borrowsCount }</span>
                                                -
                                                <span class="txt-danger">${ item.overDuesCount}</span>
                                            </td>
                                            <td <component:table-higlight
                                                    test="${isHighlight}"/>>
