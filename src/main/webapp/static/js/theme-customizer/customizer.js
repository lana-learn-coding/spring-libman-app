$(document).ready(function () {
  ...
  $('.customizer-color li').on('click', function () {
    ...
    $('#color').attr('href', staticPath + '/css/' + color + '.min.css');
  ...
  $('.sidebar-type li').on('click', function () {
    ...
    switch (type) {
      ...
      case 'normal-sidebar': {
        ...
        $('.logo-wrapper').find('img').attr('src', staticPath + '/images/logo/logo.png');
